<?php
    ...
    $id=$_GET['id'];
   echo $Sql = "SELECT answers.*,category.name as category_name,subcategory.name as subcategory_name FROM answers join category on category.id=answers.category join subcategory on subcategory.id=answers.subcategory  where answers.id='$id'  ";
...
<div class="container">
  ...
  <h6><a href="showquestions.php">Change Question :</a> <?php echo $row['questions'] ?> </h6>
  <h6>Method Description :  </h6>
    ...
    <h5>Add method</h5>
  <form action="controller/edit_answer_controller.php" method="POST">
    ...
    <div class="form-group">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="heading" id="headline" value="<?php echo $row['heading'] ?>" placeholder="Headline ">
        </div>
        <!-- (or) -->
       <br>
         <div class="form-group">
            <!-- <label for="usr">Name:</label> -->
            <input type="text" class="form-control" id="" name="type" value="<?php echo $row['type'] ?>" placeholder="method type">
        </div>
        <!-- (or) -->
       <br>
        ...
        <input type="text" class="form-control">
         ...
         <textarea id='long_desc' name='long_desc' ><?php echo $row['content'] ?></textarea>
...
<!--      <select class="form-control" id="steps" name="steps">
       ...
       <label for="sel2">Visibility</label>
        <select class="form-control" id="sel2" name="publish">
          <option class="disable" value="<?php echo $row['publish'] ?>">Previous value</option>
