<?php
  ...
  $Sql2 = "SELECT * FROM questions where id='".$_GET['id']."' ";
...
<div class="col-md-8">
  ...
  <form action="controller/edit_question_controller.php" method="post">
    <div class="form-group">
          <?php while($data = mysqli_fetch_assoc($questions)){  ?> 
      <input type="hidden" name="id" value="<?php echo $data['id']?>">

          <div class="form-group">
            <label for="sel1">Select Category (select one):</label>
      <select class="form-control" id="sel1" name="category">
        <option value="<?php echo $data['category']  ?>">previous</option>
      ...
      <select class="form-control" id="sel1" name="subcategory">
        <option value="<?php echo $data['subcategory']  ?>">previous</option>
       ...
       <br>
            ...
            <input type="text" class="form-control" id="headline" value="<?php echo $data['title'] ?>" name="title" placeholder="Headline ">
        </div>
        <!-- (or) -->
       <br>
	      <!-- <div class="input-group mb-3">
		    ...
		    <input type="text" class="form-control">
			 ...
			 <div class="form-group">
		     <textarea class="form-control" rows="5" id="comment" name="description" placeholder="Add Description"><?php echo $data['description'] ?></textarea>
		    </div>
...
<!-- 				
		...
		<select multiple="" name="location" class="form-control" id="sel2">
                        <option value="<?php echo $data['location'] ?>">previous choice</option>
